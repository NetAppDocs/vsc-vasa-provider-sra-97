---
permalink: deploy/concept_recommended_ontap_roles_when_using_vsc_for_vmware_vsphere.html
sidebar: sidebar
keywords: 
...
* 9.7 or later
+
link:task_configure_user_role_and_privileges.md#[Configuring user roles and privileges]
