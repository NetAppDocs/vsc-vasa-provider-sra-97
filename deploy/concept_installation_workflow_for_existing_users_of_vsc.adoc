...
link:reference_configure_the_vsc_preferences_files.md#[Configuring the VSC preferences files]
...
link:concept_requirements_for_deploying_the_virtual_appliance_for_vsc_vasa_provider_and_sra.md#[Requirements for deploying the virtual appliance for VSC, VASA Provider, and SRA]
