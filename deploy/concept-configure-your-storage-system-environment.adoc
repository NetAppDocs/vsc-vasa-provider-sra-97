...
* You can click the *REDISCOVER All* button in the Storage Systems page, or on a host or datacenter to select it from the *Actions* menu (menu:Actions[Netapp VSC > Update Host and Storage Data]). You can also click *DISCOVER* on the Getting Started tab of Overview section.
