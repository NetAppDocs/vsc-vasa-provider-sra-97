...
link:task_enable_vasa_provider_for_configuring_virtual_datastores.md#[Enabling VASA Provider for configuring virtual datastores]
...
[NOTE]
====
If you cannot view the plug-in even after logging in, you must clean the vSphere Client cache.    xref:task_cleaning_the_vsphere_cached_downloaded_plug_in_packages.adoc[Cleaning the vSphere cached downloaded plug-in packages]
+
====
